...
export default function Roles() {
  ...
  const adminRoles = roles.filter((role) => role.name.includes("ADMIN")).length
  const userRoles = roles.filter((role) => !role.name.includes("ADMIN") && !role.name.includes("OWNER")).length
